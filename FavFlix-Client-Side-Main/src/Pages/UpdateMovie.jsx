...
const UpdateMovie = () => {
    ...
    document.title = "FavFlix | Update Movie"
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 w-full">
                    ...
                    <div>
                        ...
                        <Select
                            ...
                            defaultValue={genreOptions.filter(option => movie.genre.includes(option.value))}
                    ...
                    <div>
                        ...
                        <Select
                            ...
                            options={yearOptions}
                            defaultValue={yearOptions.filter(year => year.value === movie.year)}
                        />
