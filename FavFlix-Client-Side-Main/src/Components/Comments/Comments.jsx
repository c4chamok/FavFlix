    ...
    return (
        <section className="flex justify-center">
            <div className="w-11/12">
                <div className=" p-6 rounded-lg shadow-lg w-full lg:w-[70%]">
                    <h2 className={`text-2xl font-bold mb-4 ${isDark ? "text-gray-200" : "text-gray-700"}`}>User Comments</h2>
                    {
                        user ?
                    ...
                    <div className="flex justify-between items-center mt-4 mb-4">
                        <h3 className={`text-2xl font-semibold ${isDark ? "text-gray-200" : "text-gray-700"}`}>Latest Comments</h3>
                        <button
